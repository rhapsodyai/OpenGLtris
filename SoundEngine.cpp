...
//SoundEngine::SoundEngine(char* fn) { this.filename =  fn; }
//SoundEngine::~SoundEngine() {}
//SoundEngine::~SoundEngine(char* fn) {}
...
int SoundEngine::playSound(char* fn) {	
	//Load our WAV file from disk
	sound = Mix_LoadWAV(fn); //FILENAME GOES HERE
	if(sound == NULL) {
...
int SoundEngine::playSoundFull(char* fn) {
